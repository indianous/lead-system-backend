...
public record CreateLeadRequest(@NotBlank String name, @NotNull LeadType leadType, String phone,
		...
		String desiredTimeline, QualificationScore qualificationScore, @NotNull UUID assignedUserId,
		List<UUID> productIds, Channel channel, SearchSource searchSource, String region, String searchSegment) {
